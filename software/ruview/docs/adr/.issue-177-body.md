> **Historical issue draft — retired 2026-09-18.** This issue body describes
> the former Tauri desktop proposal. The desktop crate and release path were
> removed; keep this file for issue-history provenance only. The current
> control surface is the browser UI plus the loopback `wifi-densepose-control`
> helper.
