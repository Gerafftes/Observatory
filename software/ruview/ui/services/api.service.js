...
export class ApiService {
  ...
  // Request a non-JSON response while keeping the same backend detection,
  // authentication, and interceptor behavior as JSON requests.
  ...
  // GET request for CSV, plain text, or other downloadable responses.
  async getText(endpoint, params = {}, options = {}) {
    const url = buildApiUrl(endpoint, params);
