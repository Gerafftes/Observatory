...
const SHELL_ASSETS = [
  ...
  'components/RoomGeometryEditor.js',
  'components/MmwaveDebugView.js',
  'components/MmwaveCalibrationAssistant.js',
  'components/gaussian-splats.js',
...
self.addEventListener('fetch', (event) => {
  ...
  // Static assets: prefer the running local server, retain cache for offline use.
  event.respondWith(networkFirst(request));
});
