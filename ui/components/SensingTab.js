...
export class SensingTab {
    ...
    this.container.innerHTML = `
      ...
      <div class="sensing-layout">
        ...
        <div class="sensing-panel">
          ...
          <div class="sensing-card">
            <div class="sensing-card-title">Position Estimate</div>
            <div class="sensing-localization">
              ...
              <div class="sensing-detail-row">
                <span>Point</span><span id="positionPointId">--</span>
              </div>
              <div class="sensing-detail-row">
                <span>Coordinates</span><span id="positionCoordinates">--</span>
              </div>
              <div class="sensing-detail-row">
                <span>Reason</span><span id="positionReason">No validated estimate yet</span>
              </div>
            </div>
          </div>
          ...
          <div class="sensing-card">
            ...
            <p class="sensing-about-text">
              ...
              estimation, and gross motion. On ESP32 hardware, a body cloud is shown
              only for a validated discrete fingerprint point while presence is true.
              The colored floor field is diagnostic link activity, not a person position.
            </p>
          </div>
  ...
  _initSplatRenderer() {
    ...
    try {
      ...
      fieldNotice.textContent = 'Diagnostische Link-Heatmap – keine Personenposition';
  ...
  _invalidateLiveReadout() {
    ...
    this._renderPositionEstimate({
      ...
      position_estimate: {
        state: 'stale',
        reason: 'Connection interrupted; previous position cleared.',
      },
    });
    ...
    const estimate =
      rawEstimate.coordinates && data?.classification?.presence !== true
        ? {
            ...
            pointId: null,
            coordinates: null,
            reason: 'No current presence confirmation; previous position cleared.',
          }
        : rawEstimate;
