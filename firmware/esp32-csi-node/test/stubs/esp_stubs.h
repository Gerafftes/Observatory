...
/* ---- esp_log.h ---- */
#define ESP_TEST_LOG_UNUSED(tag, ...) do { \
        (void)(tag);                       \
        if (0) fprintf(stderr, __VA_ARGS__); \
    } while (0)
#define ESP_LOGI(tag, ...)  ESP_TEST_LOG_UNUSED(tag, __VA_ARGS__)
#define ESP_LOGW(tag, ...)  ESP_TEST_LOG_UNUSED(tag, __VA_ARGS__)
#define ESP_LOGE(tag, ...)  ESP_TEST_LOG_UNUSED(tag, __VA_ARGS__)
#define ESP_LOGD(tag, ...)  ESP_TEST_LOG_UNUSED(tag, __VA_ARGS__)
