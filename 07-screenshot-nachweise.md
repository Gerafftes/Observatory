...
| 2026-06-28 01:39:16 | [G2-Livevisualisierung](results/2026-06-28_G2_rx-verteilung-qualitaetscheck/figures/01-live-visualisierung.png) | RuView-Webvisualisierung mit mehreren grünen Feldmaxima und mehreren Pose-/Personhypothesen | [`G2-Qualitätscheck`](results/2026-06-28_G2_rx-verteilung-qualitaetscheck/README.md) | Direkter Bildbeleg dafür, dass die Webansicht bei G2 qualitativ springt und nicht als exakte Positionsmessung genutzt werden sollte. |
| 2026-07-18 18:54:33 | [Livevisualisierung im festen Raum](results/2026-07-18_fester-raum_live-visualisierung-diagnose/figures/01-live-visualisierung.png) | RuView `Live WiFi Sensing` im festen 1TX-/4RX-Raumaufbau: Live-Verbindung, vier Marker, diffuse Punktwolke und `PRESENT_STILL 81 %` | [`Diagnose`](results/2026-07-18_fester-raum_live-visualisierung-diagnose/README.md) | Belegt den laufenden Daten-/UI-Pfad und die konkrete Fehlanzeige. Zwei Marker erscheinen nahezu überlagert; Wolke und Klassifikation waren nicht mit realer Bewegung bzw. Stillstand konsistent. Kein Positionsnachweis. |
